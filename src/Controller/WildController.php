...
class WildController extends AbstractController
{
    ...
    /**
     * Getting programs with a formatted slug for category
     * @Route("/program/{programName}", requirements={"programName"="^[0-9a-z-]+$"}, defaults={"programName": null}, name="wild_show_program")
     ...
     * @Route("/season/{id}", requirements={"id"="^[0-9]+$"}, defaults={"id"=null}, name="wild_show_season")
     * @param int $id
    ...
    /**
     * Getting episodes with an Id
     * @Route("/episode/{id}", requirements={"id"="^[0-9]+$"}, defaults={"id"=null}, name="wild_show_episode")
